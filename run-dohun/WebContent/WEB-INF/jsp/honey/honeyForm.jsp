...
$(function(){
	...
	$("#list01").jqGrid({
		...
		colNames:['No','이름','전화번호','주소','비고','주문일자','결재여부','주문내역','수량','단가','금액','운송장번호','배송일자'],
	   	colModel:[
	   		{name:'no',index:'col00',width:50,frozen:true,editable:true,editoptions:{readonly:true},align:"center"},		//no
	   		{name:'col01',index:'col01',width:70,frozen:true,editable:true,align:"center",
        ...
        ,ondblClickRow: function(rowid, iRow, iCol, e) { 		
	    	alert(iRow);
			jQuery("#gridList").viewGridRow(rowid);	 //상세보기
			//jQuery("#gridList").editGridRow(rowid, updateDialog); //수정
	    },
	    onSelectRow: function(id){
	    	console.log(id);
	    	var sel = jQuery("#list01").jqGrid("getRowData", id);  
	    	console.log(sel);
	    	console.log(sel.no);
			$("#h_no").val(sel.no);
// 	    	jQuery("#list01").jqGrid("editRow",id,true);
