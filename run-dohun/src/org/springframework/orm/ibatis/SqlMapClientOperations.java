...
public abstract interface SqlMapClientOperations {
	...
	public abstract Object queryForObject(String paramString, Object paramObject1, Object paramObject2) throws DataAccessException;
	...
	public abstract List queryForList(String paramString, Object paramObject, int paramInt1, int paramInt2) throws DataAccessException;
	public abstract void queryWithRowHandler(String paramString, RowHandler paramRowHandler) throws DataAccessException;
	public abstract void queryWithRowHandler(String paramString, Object paramObject, RowHandler paramRowHandler) throws DataAccessException;
	public abstract Map queryForMap(String paramString1, Object paramObject, String paramString2) throws DataAccessException;
	public abstract Map queryForMap(String paramString1, Object paramObject, String paramString2, String paramString3) throws DataAccessException;
